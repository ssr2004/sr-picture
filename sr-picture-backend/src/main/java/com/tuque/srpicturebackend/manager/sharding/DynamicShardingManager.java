package com.tuque.srpicturebackend.manager.sharding;

import com.baomidou.mybatisplus.extension.toolkit.SqlRunner;
import com.tuque.srpicturebackend.model.entity.Space;
import com.tuque.srpicturebackend.model.enums.SpaceLevelEnum;
import com.tuque.srpicturebackend.model.enums.SpaceTypeEnum;
...
public class DynamicShardingManager {
    ...
    private static final String DATABASE_NAME = "logic_db"; // ShardingSphere 逻辑数据库名
    ...
    private void updateShardingTableNodes() {
        ...
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "yu-picture." + tableName)
        ...
        org.apache.shardingsphere.infra.metadata.database.ShardingSphereDatabase database = databases.get(DATABASE_NAME);
        if (database == null) {
            log.error("未找到数据库 '{}', 可用数据库: {}", DATABASE_NAME, databases.keySet());
            return;
        }
