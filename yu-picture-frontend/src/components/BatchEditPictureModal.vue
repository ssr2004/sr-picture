<template>
  <a-modal v-model:visible="visible" title="批量编辑图片" :footer="false" @cancel="closeModal">
    ...
    <a-form layout="vertical" :model="formData" @finish="handleSubmit">
      ...
      <a-form-item lable="标签" name="tags">
        <a-select
      ...
      <a-form-item lable="命名规则" name="nameRule">
        <a-input
...
import { editPictureBatchUsingPost, listPictureTagCategoryUsingGet } from '@/api/pictureController'
